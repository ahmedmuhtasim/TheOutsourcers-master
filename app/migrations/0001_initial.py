# Generated by Django 2.0.4 on 2018-04-10 22:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.Person')),
                ('precinct', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.Precinct')),
            ],
        ),
        migrations.CreateModel(
            name='Ballot',
        ...
        migrations.AddField(
            model_name='measure',
            name='ballot',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Ballot'),
        ),
    ]
