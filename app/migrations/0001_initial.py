# Generated by Django 2.0.3 on 2018-03-26 19:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ballot', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.Ballot')),
            ],
        ),
        migrations.CreateModel(
            name='Measure',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measure', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.Measure')),
            ],
        ),
        migrations.CreateModel(
            name='Voter',
        ...
        migrations.AddField(
            model_name='choice',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Referendum'),
        ),
        migrations.AddField(
            model_name='candidacy',
            name='measure',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.Measure'),
        ),
        migrations.AddField(
            model_name='candidacy',
            name='office',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.Office'),
        ),
        migrations.AddField(
            model_name='candidacy',
            name='politician',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.Politician'),
        ),
        migrations.AddField(
            model_name='ballot',
            name='voter',
